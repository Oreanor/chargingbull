...
export function Prose({
  ...
  return (
    ...
    >
      <div className="prose-inner mx-auto max-w-[720px] space-y-6 text-[clamp(15px,1.25vw,18px)] leading-[1.75] text-fg">
        {children}
      </div>
    </section>
  );
  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center px-6 py-20">
      ...
      <div className="text-center max-w-[720px]">
        ...
        {children ? (
          <div className="font-light text-fg mx-auto max-w-[560px] text-[clamp(14px,1.2vw,17px)] leading-[1.7]">
            {children}
          </div>
        ) : null}
      </div>
  ...
  return (
    <section className="min-h-[90svh] flex items-center justify-center px-6 py-20">
      <div className="text-center max-w-[720px]">
        ...
        {lines.map((l, i) => (
          <p
            ...
            className={`font-serif leading-[1.15] text-[clamp(36px,5vw,64px)] ${
              l.emphasis ? 'italic text-gold mb-16' : 'text-fg font-medium'
            }`}
          >
            {l.text}
          </p>
        ...
        {credit ? (
          <div className="uppercase text-[11px] tracking-[1.6px] text-fg leading-[2]">
            {credit}
          </div>
        ) : null}
      </div>
